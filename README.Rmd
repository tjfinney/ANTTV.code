...
ANTTV is a package of *R* programs for analysing data on New Testament textual variation. [How to discover textual groups](https://www.digitalstudies.org/article/id/7324/) provides an introduction to the techniques involved.
...
Please be aware that reducing the minimum number will also reduce the reliability of the analysis results.

## Saving results

Results of an analysis function (i.e. `do_CMDS()`, `do_DC()`, `do_NJ()`, `do_PAM()`) can be saved by setting the *write* flag to `TRUE` and specifying an output file:
